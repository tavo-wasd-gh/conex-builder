...
}).render("#paypal-extend-button-container");

function checkoutExtendedSuccess(message) {
    const container = document.querySelector("#checkout-extended-success-message");
    container.style.display = "block";
    container.innerHTML = message;
}

function checkoutExtendedError(message) {
    const container = document.querySelector("#checkout-extended-error-message");
    container.style.display = "block";
    container.innerHTML = message;
}
